...
- **Prog Wizard**: Generate jazz progressions (ii-V-I, turnarounds, tritone subs) from a starting chord
...
| `prog-wizard.md` | Jazz progression generator (ii-V-I, turnarounds, etc.) |
