 ...
 *
 * Basic transforms (drop, spread, inversion) and register constraints.
 * Jazz-specific voicings (rootless, shell, quartal) are in jazzVoicings.ts.
 */

import type { MIDINote, VoicingStyle, Chord } from "../types";
import {
  applyRootlessA,
  applyRootlessB,
  applyShell,
...
export function constrainToRegister(
  ...
  return notes.map((n) => clampMIDI(n + shift));
}

// ============================================================================
// Re-exports from jazzVoicings for backwards compatibility
// ============================================================================

export { applyRootlessA, applyRootlessB, applyShell, applyQuartal, applyUpperStructure };
